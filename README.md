...
- `GET /decisions/{record_id}/audit?start=...&end=...`：查询约束、校验顺序、成功 JSON 口径及 422/404/503 状态与 `detail` 体均同 `GET /decisions/{record_id}/evolution`，成功返回 `audit` 方法契约的 JSON。
